...
const Blogs = () => {
  ...
  const getBlogs = async (page) => {
    try {
      const response = await axios.get(`http://localhost:3000/blog/posts?page=${page}&limit=5`, { // Adjust limit as needed
        headers: {
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 gap-6">
        {blogs.map((blog) => (
          <div
            key={blog._id}
            className="bg-gray-100 rounded-lg shadow-md p-8 h-96"
          >
